      ...
      <div className="container mx-auto px-10">
        <div className="flex items-center justify-between h-24">
          ...
          <a href="#" className="flex items-center">
            <img src={logoImg} className="h-16" alt="Company Logo" />
          </a>
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-6 font-semibold">
            ...
            <a href="#" className="text-gray-700 hover:border-b-4 hover:border-primary transition-all duration-300 hover:scale-105">Webinars</a>
            <a href="#" className="text-gray-700 hover:border-b-4 hover:border-primary transition-all duration-300 hover:scale-105">Career</a>
      ...
      {isOpen && (
        <div className="lg:hidden transition-all duration-300 ease-in-out">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 transition-colors duration-200">Webinars</a>
            <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 transition-colors duration-200">Career</a>
